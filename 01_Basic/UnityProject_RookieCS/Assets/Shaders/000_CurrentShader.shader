Shader "Cell/Current"
{
    Properties
    {
        ...
        _AmbientLight ("Ambient Light", Color) = (0.10,0.13,0.20,1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (VertexOutput o) : SV_Target
            {
                ...
                float FO_light_trans_output_lowerLim = min(_PenumbraIntensity + _PenumbraRange, FO_light_trans_output_upperLim);
                ...
                float FO_penumbra_output_lowerLim = min(_PenumbraIntensity, FO_penumbra_output_upperLim);
                ...
                float FO_penumbra_trans_output_lowerLim = min(_ShadowIntensity + _ShadowRange, FO_penumbra_trans_output_upperLim);
                ...
                float FO_shadow_output_lowerLim = min(_ShadowIntensity, FO_shadow_output_upperLim);
                ...
                float CS_Spec_penumbra_input_upperbound = CS_Spec_penumbra_input_lowerbound + transGap;
                ...
                float compositeFalloff = rawDiffuseFalloff;
                compositeFalloff = min(1,compositeFalloff);
                compositeFalloff = max(-1,compositeFalloff);
                ...
                if (compositeFalloff > FO_light_input_lowerLim) {
                  ...
                  ambientFalloff = remap(FO_shadow_input_lowerLim, FO_shadow_input_upperLim, FO_shadow_output_lowerLim, 1, compositeFalloff);
                }
                ...
                // Light Composition
                float3 compositeLight = directDiffuse + (ambientLight * ambientFalloff);
